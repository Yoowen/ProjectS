package me.goowen.projects.framework.essentials;
...
public class WarpLoader {
    ...
    public CompletableFuture<Void> saveWarp(WarpLocation warp){
        return CompletableFuture.runAsync(() -> {
            ...
            projectS.getLog().info(ChatColor.DARK_AQUA + "[WarpLoader] has failed to save a new warp by the name: " + warp.getTagg());
