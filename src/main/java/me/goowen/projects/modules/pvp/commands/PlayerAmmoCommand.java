    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        switch (args[0]) {
            case "create":
                ...
                ProjectS.getPvpModule().getAmmoLoader().saveAmmo(new Ammo(tagg, bullets, ammoItem, 1, 5, 300, 2, 60, 1, 1));
            ...
            case "get":
                ...
                if (ProjectS.getPvpModule().getAmmo(args[1]).isPresent()) {
                    Ammo ammo = ProjectS.getPvpModule().getAmmo(args[1]).get();
            ...
            case "reload":
                ...
                ProjectS.getPvpModule().reloadAmmo();
