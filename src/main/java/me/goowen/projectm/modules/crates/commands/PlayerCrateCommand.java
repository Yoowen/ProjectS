...
public class PlayerCrateCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String s, String[] args)
    {
        ...
        if (args.length == 0 || args.length > 3) {
            sender.sendMessage(ChatColor.RED + "Wrong usage, use /crate <option>.");
            return true;
        }
        ...
        switch (args[0]) {
            ...
            case "crateLog":
                ...
                if (!projectMPlayer.isCratesLog()) {
                    ...
                    player.sendMessage(ChatColor.DARK_AQUA + "Citycraft " + ChatColor.WHITE + "- Chat log for crates has been enabled.");
                } else {
                    projectMPlayer.setCratesLog(false);
                    player.sendMessage(ChatColor.DARK_AQUA + "Citycraft " + ChatColor.WHITE + "- Chat log for crates has been dissabled.");
                }
                return true;
            ...
            case "createItem":
                ...
                player.sendMessage(ChatColor.DARK_AQUA + "Citycraft " + ChatColor.WHITE + "- Crate item succesfully created under the name " + args[1]);
                return true;
            ...
            case "forceReplaceAll":
                ...
                player.sendMessage(ChatColor.DARK_AQUA + "Citycraft " + ChatColor.WHITE + "- all crates have been replaced");
                return true;
            ...
            case "setAmount":
                ...
                player.sendMessage(ChatColor.DARK_AQUA + "Citycraft " + ChatColor.WHITE + "- crate amount has been set to " + args[1]);
                return true;
            ...
            case "reloadItems":
                ...
                player.sendMessage(ChatColor.DARK_AQUA + "Citycraft " + ChatColor.WHITE + "- Crate item list has been reloaded.");
                return true;
