        ...
        if (args.length == 1) {
            ...
            switch (argument1.toLowerCase()) {
                ...
                case "1":
                    ...
                    player.sendMessage(ChatColor.DARK_AQUA + "Citycraft " + ChatColor.WHITE + "- Gamemode succesfully set to creative.");
                    return true;
                case "survival":
                case "s":
                case "0":
                    ...
                    player.sendMessage(ChatColor.DARK_AQUA + "Citycraft " + ChatColor.WHITE + "- Gamemode succesfully set to survival.");
                    return true;
                case "spectator":
                case "3":
                    ...
                    player.sendMessage(ChatColor.DARK_AQUA + "Citycraft " + ChatColor.WHITE + "- Gamemode succesfully set to spectator");
                    return true;
                case "adventure":
                case "a":
                case "2":
                    ...
                    player.sendMessage(ChatColor.DARK_AQUA + "Citycraft " + ChatColor.WHITE + "- Gamemode succesfully set to adventure");
                    return true;
                default:
                    sender.sendMessage(ChatColor.RED + "Wrong usage, please use /gamemode <player> <gamemode>");
                    return true;
            }
            ...
            switch (argument1.toLowerCase()) {
                ...
                case "1":
                    ...
                    player.sendMessage(ChatColor.DARK_AQUA + "Citycraft " + ChatColor.WHITE + "- Gamemode of " + other.getName() + " succesfully set to creative.");
                    return true;
                case "survival":
                case "s":
                case "0":
                    ...
                    player.sendMessage(ChatColor.DARK_AQUA + "Citycraft " + ChatColor.WHITE + "- Gamemode of " + other.getName() + " succesfully set to survival.");
                    return true;
                case "spectator":
                case "3":
                    ...
                    player.setGameMode(GameMode.SPECTATOR);
                    player.sendMessage(ChatColor.DARK_AQUA + "Citycraft " + ChatColor.WHITE + "- Gamemode of " + other.getName() + " succesfully set to spectator");
                    return true;
                case "adventure":
                case "a":
                case "2":
                    ...
                    player.sendMessage(ChatColor.DARK_AQUA + "Citycraft " + ChatColor.WHITE + "- Gamemode of " + other.getName() + " succesfully set to adventure");
                    return true;
                default:
                    sender.sendMessage(ChatColor.RED + "Wrong usage, please use /gamemode <player> <gamemode>");
                    return true;
